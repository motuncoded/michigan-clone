      ...
      <StyledContainer>
        <StyledHero>
          ...
          <StyledHeroList>
            ...
            <StyledTitle>
              <StyledHeader> Who we are</StyledHeader>
              <StyledHeading>
                Modern marketing, sales and customer service solutions.
              </StyledHeading>
              <StyledParagraph>
                We help you streamline and automate your systems and processes
                with marks that drives decisions get data-driven attribution
                reporting and a 300-degree view of your prospect and customers
                layers journeys.
              </StyledParagraph>
